...
class ImportantAuthor {
    ...
    function getIndiceSexenio() {
        return $this->indiceSexenio;
    }

    function setIndiceSexenio($indiceSexenio) {
        $this->indiceSexenio = $indiceSexenio;
        return $this;
    }
